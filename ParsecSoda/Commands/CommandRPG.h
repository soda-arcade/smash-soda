...
public:
	...
	/// <summary>
	/// This handles the basic logic of the command.
	/// </summary>
	/// <returns></returns>
	bool run() override {
...
protected:
	...
	/// <summary>
	/// Ooooh, a chest! What could be inside?
	/// </summary>
	...
	/// <summary>
	/// Some generic monster names to use in the RPG sentences.
	/// </summary>
	...
	/// <summary>
	/// Random warrior names to use in battles because I can't
	/// be bothered to handle logic for when sender's name is picked. :P
	/// </summary>
	...
	/// <summary>
	/// Replaces placeholders in a string with the values provided in a map.
	/// </summary>
