...
public:
	...
	bool run() override
	{
		...
		{
			_replyMessage = MetadataCache::preferences.chatbotName + " | Usage: !gameid <id>\nExample: !gameid 1RR6JAsP4sdrjUOMEV4i7lVwMht\0";
			return false;
		}
		...
		{
			_replyMessage = MetadataCache::preferences.chatbotName + " | Failed to write game ID.\0";
			return false;
		}

		_replyMessage = std::string() + MetadataCache::preferences.chatbotName + " | Game ID changed:\n" + _stringArg + "\0";
		return true;
	}
